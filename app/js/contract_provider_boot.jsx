...
var MainApp = require('./views/provider/providerApp.jsx');
...
$(function(){
	ProviderStore.initProvider().then(EmployeeStore.initial).then(function(){
		React.render( <MainApp />, document.getElementById('container') );
		React.render( <FormCreateProvider />, document.getElementById('pop-contract') );
		React.render( <FormUpdateProvider />, document.getElementById('pop-contract-update') );
